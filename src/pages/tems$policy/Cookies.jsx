      ...
      <section className="tp-page-area pb-80 pt-50">
        <div className="container">
          <div className="ck-content">
            <h1 className="section-heading"><strong>Cookie Policy for GRACEGLOW BEAUTY PRODUCTS PRIVATE LIMITED </strong></h1>
            ...
            <ul className="terms-list">
              <li>Email: <a href="mailto:Info@GRACEGLOW BEAUTY PRODUCTS PRIVATE LIMITED.in">Info@GRACEGLOW BEAUTY PRODUCTS PRIVATE LIMITED.in</a></li>
            </ul>
          </div>
        </div>
      </section>
