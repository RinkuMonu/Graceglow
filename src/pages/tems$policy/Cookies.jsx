      ...
      <section className="tp-page-area pb-80 pt-50">
        <div className="container">
          <div className="ck-content">
            <h1 className="section-heading"><strong>Cookie Policy for DigiHUbUnique Small Pvt Ltd</strong></h1>
            ...
            <ul className="terms-list">
              <li>Email: <a href="mailto:Info@DigiHUbUnique.in">Info@DigiHUbUnique.in</a></li>
            </ul>
          </div>
        </div>
      </section>
