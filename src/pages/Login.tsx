    ...
    <div className="min-h-[calc(100vh-4rem)] bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-lg w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
        <div className="flex gap-4">
          <div className="pt-4 ">
            {isLogin ? (
              <Lock className="pl-3 h-10 w-8 text-purple-400 pointer-events-none" style={{
                color:"#468125",
              }} />
            ) : (
        ...
        >
          ...
          <button
            type="submit"
            className="group relative w-full flex justify-center items-center py-3 px-4 border border-transparent text-base font-medium rounded-md text-white bg-[#55833d] hover:bg-[#55833d]focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            disabled={isLoading}
          >
            {isLoading ? (
              <DotLottieReact
