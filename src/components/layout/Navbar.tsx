                ...
                <form className="w-full">
                  <div className="relative">
                    <input
                      ...
                      required
                      style={{ border: "2px solid rgb(85 131 61)" }}
                    />
                    <button
                      type="submit"
                      className="absolute top-0 right-0   text-white"
                      style={{
                        backgroundColor: "rgb(85 131 61)",
                        height: "100%",
                        width: "12%",
                        display: "flex",
                ...
                <div className="flex items-center justify-between p-4  border-gray-300 gap-1 sm:gap-4 md:gap-20">
                  <div className="relative group">
                    ...
                    <Link
                      ...
                      className="flex items-center space-x-1 hover:text-[#55833d]"
                    >
                      ...
                      <span className="hidden sm:inline">
                        {user ? (
                          ...
                          <div>
                            ...
                            <a href="/login" className="text-[#55833d] text-sm">
                              Login / Register
                            </a>
                          </div>
                        )}
            ...
            Logout
                  ...
                  <div className="flex items-center sm:gap-6">
                    ...
                    <div className="relative flex items-center">
                      ...
                      <span className="absolute -top-2 -right-2 bg-[#55833d] text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
                        {/* {wishlistCount} */}0
                      </span>
                    </div>
            ...
            <nav className="flex space-x-8 h-13 text-base items-center">
              ...
              {categories.map((item) => (
                <Link
                  key={item}
                  to={`/category/${item.toLowerCase()}`}
                  className="hover:text-[#55833d] hover:border-b-2 hover:border-[#55833d] h-full flex items-center"
                >
                  {item}
                </Link>
              ))}
